...
<<<<<<< Updated upstream
                    ...
                    Supplier = Convert.ToString(ExtractValue(row[10])) ?? string.Empty,
                    ImagePath = Convert.ToString(ExtractValue(row[11])) ?? string.Empty,
                    Model = Convert.ToString(ExtractValue(row[12])),
